...
from suite.suite_drive.doctype.drive_permission.drive_permission import DrivePermission
...
class UnitTestDrivePermission(UnitTestCase):
    ...
    @patch("suite.suite_drive.doctype.drive_permission.drive_permission.frappe.enqueue")
