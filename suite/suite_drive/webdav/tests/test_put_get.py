...
from suite.suite_drive.utils.files import FileManager, get_s3_url, storage_key
from suite.suite_drive.webdav import get as get_module
...
def pending_putparts(name: str) -> list:
    ...
    from suite.suite_drive.webdav import put as put_module
...
class TestWebDAVPut(IntegrationTestCase):
    ...
    def test_put_compensation_follows_a_move(self):
        ...
        from suite.suite_drive.utils import apply_file_size_delta
    ...
    def test_put_compensation_after_trash_skips_settled_accounting(self):
        ...
        from suite.suite_drive.utils import STATUS_TRASHED, apply_file_size_delta
    ...
    def test_put_statuses(self):
        from suite.suite_drive.webdav.errors import BadRequest, Conflict, Forbidden, MethodNotAllowed
    ...
    def test_put_quota_is_507_and_cleans_scratch(self):
        ...
        from suite.suite_drive.webdav.errors import InsufficientStorage
