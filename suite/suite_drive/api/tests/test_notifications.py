...
from suite.suite_drive.api.notifications import mark_as_read, send_share_email
...
class TestShareEmail(UnitTestCase):
    @patch("suite.suite_drive.api.notifications.drive_logo_inline_images", return_value=[])
    @patch("suite.suite_drive.api.notifications.frappe.sendmail")
