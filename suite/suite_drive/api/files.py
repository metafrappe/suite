...
from suite.suite_drive.utils import get_root_folder as drive_root
from suite.suite_drive.utils.api import prettify_file
from suite.suite_drive.utils.files import (
    FileManager,
    content_disposition,
    get_s3_key,
    get_s3_url,
...
from suite.suite_drive.utils.users import mark_as_viewed
...
def download_folder(entities: str):
    ...
    frappe.enqueue(
        "suite.suite_drive.api.files.build_download_archive",
        queue="long",
        timeout=3600,
        token=token,
        entities=entities,
