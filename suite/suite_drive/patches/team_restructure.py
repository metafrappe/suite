...
def execute():
    ...
    frappe.reload_doc("Suite Drive", "doctype", "Drive Team Member")
    frappe.reload_doc("Suite Drive", "doctype", "Drive Team")
    frappe.reload_doc("Suite Drive", "doctype", "Drive File")
    frappe.reload_doc("Suite Drive", "doctype", "Drive Permission")
    frappe.reload_doc("Suite Drive", "doctype", "Drive Entity Activity Log")
