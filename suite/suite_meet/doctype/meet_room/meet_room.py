...
from suite.suite_meet.utils.user import get_user_info
...
class MeetRoom(Document):
    ...
    if TYPE_CHECKING:
        ...
        from suite.suite_meet.doctype.meet_room_user.meet_room_user import MeetRoomUser
    ...
    def has_active_recording(self) -> bool:
        from suite.suite_meet.doctype.meet_recording.meet_recording import ACTIVE_RECORDING_STATUSES
