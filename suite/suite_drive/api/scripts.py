...
from suite.suite_drive.api.files import delete_entities
from suite.suite_drive.api.product import is_drive_site_admin
...
def clear_download_archives():
    ...
    from suite.suite_drive.api.files import ARCHIVE_DIR, DOWNLOAD_TTL
