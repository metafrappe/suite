...
```sh
curl -fsSL https://raw.githubusercontent.com/frappe/suite/develop/suite/suite_meet/recorder-server/deploy/install.sh | sudo bash
...
CHROMIUM_EXECUTABLE=/usr/bin/chromium RECORDER_CHROMIUM_NO_SANDBOX=1 yarn --cwd suite/suite_meet/recorder-server test
```
