...
from suite.suite_drive.api.files import get_file_type
...
from suite.suite_drive.api.product import create_invites
...
from suite.suite_drive.utils.files import S3_URL_PREFIX, FileManager, get_s3_url, storage_key
...
class File(FrappeFile):
    ...
    def create_for_doc(
        ...
        from suite.suite_drive.utils import create_file
