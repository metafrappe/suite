...
from suite.suite_drive.utils.api import get_default_access
from suite.suite_drive.utils.overrides import file_permission_criterion
...
def _get_slide_counts(rows):
    ...
    """
    # Imported here as suite.slides imports from suite.suite_drive.
